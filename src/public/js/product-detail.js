...
fetch(API_URL)
    ...
    .then(data => {
        ...
        const { categoryId, description, id, keyWord, name, mainImage, subImage, price, _id } = result;
        ...
        setCartButton.addEventListener('click', function() {
            ...
            if (itemCount === null) {
                ...
                const option = document.querySelector('.option-name').firstElementChild.textContent;
                const quantity = Number(document.querySelector('.option-count').firstElementChild.value);
        ...
        // 바로구매
        const directPayButton = document.querySelector('.buy-button').lastElementChild;
